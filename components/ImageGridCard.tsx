    ...
    return (
        <div className="lg:h-full flex flex-col justify-between gap-2">
            <div className="flex justify-between items-center mb-4">
                <span className="text-sm font-bold">Velg bilde</span>
            ...
            {showPopup && (
                <div
                    ref={popupRef}
                    className="absolute top-0 -right-96 bg-white p-4 border rounded shadow-lg z-50"
                    style={{ zIndex: 1000, width: '35vw' }}
                >
